...
Usage:
    ...
    python weed.py data/books_2_ris.txt --students data/Uitleen_2019-2026.csv --staff data/Uitleen_collega's.csv --out data/output/weeding_report7.xlsx
...
OUTBREAK_TIMELINE = [
    ...
    {"event": "Broad Street cholera outbreak (John Snow)",
     "keywords": ["john snow", "broad street", "snow on cholera"]},

    {"event": "Discovery of TB bacteria (Koch)",
     "keywords": ["koch", "tubercle bacillus", "robert koch"]},

    {"event": "Mosquito transmission of Malaria (Ross)",
     "keywords": ["ronald ross", "ross institute", "mosquito transmission of malaria"]},

    {"event": "Yellow fever transmission (Walter Reed)",
     "keywords": ["walter reed", "yellow fever commission", "reed commission"]},

    {"event": "Discovery of Chagas disease",
     "keywords": ["chagas disease", "carlos chagas", "trypanosoma cruzi"]},

    {"event": "1918 Influenza pandemic",
     "keywords": ["spanish flu", "1918 influenza", "influenza pandemic 1918",
                  "pandemic influenza 1918", "1918 pandemic"]},
    ...
    {"event": "Global smallpox eradication programme",
     "keywords": ["smallpox eradication", "eradication of smallpox",
                  "global eradication", "smallpox programme"]},
    ...
    {"event": "Global expansion of Dengue",
     "keywords": ["dengue pandemic", "dengue epidemic", "dengue outbreak",
                  "dengue fever epidemic", "dengue haemorrhagic fever"]},

    {"event": "Mpox outbreaks",
     "keywords": ["mpox", "monkeypox outbreak", "monkeypox epidemic"]},

    {"event": "Ebola outbreak in West Africa",
     "keywords": ["ebola", "ebola virus", "ebola outbreak", "ebola epidemic"]},

    {"event": "COVID-19 pandemic",
     "keywords": ["covid", "sars-cov", "coronavirus pandemic", "covid-19"]},
]
...
def matches_outbreak(title, abstract, keywords):
    # Keywords excluded from haystack — auto-assigned from abstract and unreliable.
    # Matching on title + abstract only, using tighter multi-word phrases.
...
def main():
    ...
    parser.add_argument("--out",             default="data/output/weeding_report7.xlsx", help="Output XLSX filename")
